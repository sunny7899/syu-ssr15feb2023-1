...
export class VideoGalleryComponent implements OnInit {
 ...
 public submitForm1() {
  if (this.RegistrationFrom1.valid) {
   ...
   this.http.get(`https://bizcallcrmforms.com/response.php?cCandidateName=${cCandidateName}&cEmail=${cEmail}&cCode=${cCode}&cMobile=${cMobile}&cCity=Na&cCourse=Na&cLinkName=https://bizcallcrmforms.com/response.php?cCandidateName=${cCandidateName}&cEmail=${cEmail}&cMobile=${cMobile}&cLinkName=https://www.selectyouruniversity.com/video-gallery&section=insertdetails`)
     .subscribe((res) => {
       console.log('res', res)
       this.nsrNo = res
