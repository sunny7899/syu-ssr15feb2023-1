...
export class ServicesComponent implements OnInit {
 ...
 public submitForm1() {
  if (this.RegistrationFrom1.valid) {
   ...
   this.http.get(`https://bizcallcrmforms.com/response.php?cCandidateName=${cCandidateName}&cEmail=${cEmail}&cCode=${cCode}&cMobile=${cMobile}&cLinkName=https://www.selectyouruniversity.com/services&cCity=Na&cCourse=Na&section=insertdetails`)
     .subscribe((res) => {
       console.log('res', res)
       this.nsrNo = res
