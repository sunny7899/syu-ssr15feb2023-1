...
export class AllBlogsComponent implements OnInit {
  ...
  public submitForm1() {
    ...
    this.http.get(`https://bizcallcrmforms.com/response.php?cCandidateName=${cCandidateName}&cEmail=${cEmail}&cCode=${cCode}&cMobile=${cMobile}&cCity=Na&cCourse=Na&cLinkName=https://www.selectyouruniversity.com/${this.url[1]}/${this.url[2]}/${this.url[3]}/&section=insertdetails`)
      .subscribe((res) => {
        console.log('res', res)
        this.nsrNo = res
