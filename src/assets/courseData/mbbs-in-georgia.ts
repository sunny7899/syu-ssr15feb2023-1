export const mbbsingeorgia= {
    ...
    "url":"mbbs-in-georgia",
        ...
        {
            type: 'list-bollet',
            title: 'What are the Eligibility Criteria for MBBS Admission in Georgia?',
            info: 'All the Indian students have to fulfill the required qualification to take admission to MBBS degree in Georgia:',
            data: [
        ...
        {
            type: 'step-list',
            title: 'How to Take Admission for Studying MBBS in Georgia?',
            info: 'Follow these simple steps to take admission to Georgia’s best medical universities:',
            data: [
        ...
        },
        {
            ...
            info: 'Make sure you have all of these documents ready for taking admission to MBBS course in Georgia. Following documents are required for obtaining a study visa:',
            data: [
        ...
        {
            type: 'list-bollet',
            title: 'Recognition of Georgia Medical Universities',
            info: 'Georgian medical universities are recognized worldwide with the following accreditations:',
            data: [
    ...
    },
    {
        ...
        data: "<p>Studying MBBS in Georgia is much safer than any other country. According to <strong>Global Peace Index</strong>, Georgia stands on <strong>85th position</strong>, while India holds 141st rank and USA stands on 103rd position according to it.</p>"
    },
          {
            ...
            "row": [
                ...
                {
                    "Particulars": "No. of NMC approved medical universities/colleges",
                    "Georgia": "10",
                    "Ukraine": "107"
                },
                {
                    "Particulars": "Tuition Fee budget",
                    "Georgia": "Rs.2.50 - 7.50 Lacs P.A.",
                    "Ukraine": "Rs.2.45 - 4.90 Lacs P.A."
                },
                {
                    "Particulars": "NMC Passing ratio",
                    "Georgia": "25.5%",
                    "Ukraine": "19.1%"
                }
            ]
        ...
        {
            type: 'list-bollet',
            title: 'Are there any Hostel Facilities provided by Georgian Medical Universities?',
            info: 'Georgian universities take care of foreign students very well. Students are provided with accommodation options with the following facilities:',
            data: [
        ...
        
        {
            ...
            info: 'Since choosing accommodation is also as important as choosing the right university, students need to keep these things in mind:',
            data: [
        ...
        {
            type: 'list-bollet',
            title: 'Will I Get any Scholarships for Studying MBBS in Georgia?',
            info: '',
            data: [
                "Georgia is a great choice for MBBS studies. There are top NMC approved medical universities in Georgia. The fee structure of all the universities is very much affordable.",
                "There is no scholarship for Indian medical students in Georgia. Students can apply for an education loan from India to cover the expenses."
            ]
        },
        {
            type: 'text',
            title: 'Address of Georgia Embassy in India',
    ...
    "syllabus":[
        ...
        {
            "type": "list-bollet",
            "title": "How many years does it take to become a Doctor in Georgia?",
            "info": "The course duration that takes to become a doctor by MBBS course in Georgia includes full-time study and internship:",
            "data": [
                "The Georgian medical universities offer the MBBS course with 6 years duration.",
                "This includes the 5 years of the full-time study program and 1 year of internship.",
                "Every year includes 2 semesters of 6 months."
            ]
        },
        {
            "type": "table",
            "title": "What is the MBBS Syllabus in Georgia?",
            "info": "The syllabus for MBBS in Georgian Medical colleges covers a lot of different subjects. Here is the syllabus for 12 semesters of MBBS degree in Georgia:",
            "col": [
                "1st Year",
                "2nd Year",
            ],
    ...
    "careeroptions":[
        {
            ...
            "info": 'After completing an MBBS degree from Georgia’s NMC approved top MBBS universities students have vast career options:',
            "data": [
        ...
        {
            "type": 'list-bollet',
            "title": 'Where Can We Apply for PG after Completing MBBS from Georgia?',
            "info": 'The students after completing MBBS from Georgian medical universities can opt to practice in many countries. There are also some PG options for students provided that they have to clear the screening tests of respective countries.Students after completing MBBS from Georgia can have the following options:',
            "data": [
    ...
    "faq": [
        {
            ...
            "data": [
                ...
                {
                    "ques": "Q. What is the age limit for studying MBBS in Georgia?",
                    "ans": "The students should be at least 17 years old and a maximum of 25 years old to study MBBS in Georgia."
                },
                {
