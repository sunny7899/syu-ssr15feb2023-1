export const internationalfoundationofmedicineifom = {
    ...
    "info": [
        ...
        },
        {
            ...
            "data": '<p><strong>1. IFOM - BSE Exam</strong></p><p>IFOM Basic Science Examination is developed to assess international knowledge with respect to medical students who have completed the preclinical curriculum & wants to start their study of clinical medicine.</p><p><strong>2. IFOM - CSE Exam</strong></p><p>IFOM Clinical Science Examination is developed to assess clinical knowledge in medicine, surgery, pediatrics, surgery, etc. for those students who are in the final year of undergraduate medical education.</p>'
        },
        {
            "type": "list-bollet",
