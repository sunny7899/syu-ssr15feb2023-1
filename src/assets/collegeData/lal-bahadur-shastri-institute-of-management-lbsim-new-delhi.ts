export const lalbahadurshastriinstituteofmanagementlbsimnewdelhi = {
    "Title": "Lal Bahadur Shastri Institute of Management",
    "shortTitle": "Lal Bahadur Shastri Institute of Management",
    "location": " India",
    "type": "",
    "rating": "",
    "shareLink": "",
    ...
    "info": [
      {
...

        {
            ...
            "row": [
                ...
                ["<b>Entrance Examination</b>", "CAT and GMAT exams"],
                ["<b>Tuition Fees</b>", "PGDM General -11,67,000 Rs<br>PGDM finance - 11,67,000 Rs<br>PGDM Executive - 5,70,000 Rs<br>PGDM Part-time -3,25,500 Rs"],
                ["<b>Medium of Instruction</b>", "English language"],
                ["<b>University Recognition</b>", "AICTE, NCTE, NAAC, Ministry of HRD, Govt. of India, NBA"],
                ["<b>Affiliation</b>", "Guru Gobind Singh Indraprastha University (GGSIPU)"],
...

        {
            ...
            "data": [
                ...
                "The students can be accommodated in well furnished, spacious and hygienic residential hostels provided by LBSIM.",
                "Lal Bahadur Shastri Institute of Management has highly qualified faculty members with decades of experience.",
                "The college has state-of-art Infrastructure and fully air conditioned building furnishing all basic facilities to the students.",
                "Lal Bahadur Shastri Institute of Management also organizes seminars, workshops, conferences and guest lectures.",
                "The students can also participate in sports activities during management education.",
                "Lal Bahadur Shastri Institute of Management offers a canteen facility on campus, where nutritious and delicious food is provided to the students.",
                "The management degree from LBSIM has global recognition."
            ]
        },
        {
            "type": "list-bollet",
        ...
        {
            "type": "list-bollet",
            "title": "Facilities Offered by LBSIM",
            "info": "Checkout some important facilities provided at Lal Bahadur Shastri Institute of Management, Delhi:",
            "data": [
                "Library",
                "Cafe",
                "Auditorium",
        ...
        {
            "type": "table",
            "title": "Extracurricular Activities at LBSIM",
            "info": "The cultural club in alliance with SPIC MACAY annually organizes a one-day cultural event. Last year, a Purulia Chhau dance performance was held in November 2012.<br><b>Apart from the above, cultural club throughout the year organizes a variety of activities including-</b>",
            "col": [],
            "row": [
                ["Cultural Week", "Dandiya Night"],
                ["Mantra Night", "Teacher’s Day"],
                ["Tatva (The Cultural, Management, and Technical Fest at LBSIM)", "Fresher’s Party"],
                ["Razzmatazz Night", "Razzmatazz Night"],
                ["Foundation Day", "Farewell Party"],
        ...
        {
            "type": "list-bollet",
            "title": "Teaching Methodology at LBSIM",
            "info": "",
            "data": [
                "The teaching and instructional methods encourage learning through student industry interaction in the form of practical assignments and projects.",
                "The college environment is experiential, fun, enjoyable, and highly conducive for better learning."
            ]
        },
        {
            "type": "list-bollet",
        ...
        },
        {
            ...
            "data": [
                ...
                "Sudha Sisla student of PGDM-1st year has won 1st Prize in the Humans of Campus competition conducted by SIIB, Pune."
            ]
        },
        {
            "type": "list-bollet",
            ...
            "data": [
                ...
                "Mantra Band was awarded for the `Best Vocals’ in the Battle of Bands Competition at Institute of Management & Technology Annual Fest 2015"
            ]
        },
        {
            "type": "list-bollet",
            ...
            "data": [
                ...
                "LBSIM students won laurels in various sports competitions held at various institutes."
            ]
        },
        {
            "type": "list-bollet",
    ...
    "coursesandfees": [
...

        {
            ...
            "row": [
                {
                    "Course": "<b>PGDM-General</b>",
                    "Fee Structure ": "11,67,000 Rs",

                },
                {
                    "Course": "<b>PGDM-Finance</b>",
                    "Fee Structure ": "11,67,000 Rs",

                },
                {
                    "Course": "<b>PGDM-Executive</b>",
                    "Fee Structure ": "5,70,000 Rs",
        ...
        },
        {
            ...
            "data": [
                ...
                "Post Graduate Diploma in Management - Logistics & Supply Chain Management",
      ...
      "admission":[
...

        {
            ...
            "data": [
                ...
                "Candidates are short-listed based on CAT/ GMAT scores.",
                "The international students just carry a valid passport."
            ]
        },
...

        {
            ...
            "data": [
                ...
                "Submit requisite demand drafts.",
                "The candidates should submit the character certificate.",
                "Carry graduation certificate at the time of PGDM admission.",
                "The candidates must submit the CAT/ GMAT exam scores.",
                "Submit the caste certificate before admission.",
                "Carry migration certificate during admission time.",
                "The candidates must carry COVID-19 reports to take admission.",
                "Every candidate must submit the Birth certificate for admission.",
                "The candidate should submit Passport size photographs during admission time.",
                "The international students must carry a valid passport copy to take admission.",
                "The candidates should submit the school leaving certificate.",
            ...
            "data": [
                {
                    ...
                    "ans": "The total number of seats offered is 480 at Lal Bahadur Shastri Institute of Management, Delhi."
                },
                {
                    "ques": "Is Lal Bahadur Shastri Institute of Management, Delhi approved/ recognised?",
                    "ans": "Lal Bahadur Shastri Institute of Management, Delhi is recognised by the AICTE, Ministry of HRD, Govt. of India and NBA."
                },
                {
                    "ques": "What is the mode of application at Lal Bahadur Shastri Institute of Management, Delhi?",
                    "ans": "Lal Bahadur Shastri Institute of Management, Delhi has both online and offline mode of application."
                },
                {
                    "ques": "Which are the top recruiting companies for Lal Bahadur Shastri Institute of Management, Delhi?",
                    "ans": "Many renowned recruiters visited the campus for placements such as Maruti Suzuki, Deloitte, Accenture, Infosys, Accenture, Aon Hewitt, Asian Paints, Click Labs, Daffodil Software, Ericsson India, HCL, HDFC Bank, IGATE, Infosys, JK Technosoft, JP Morgan Chase, L T Finance, Mahindra and Mahindra, Maruti Suzuki, Naukri.com, Nestle, Newgen, Nucleus Software, Samsung, Sony, TCS, Tech Mahindra, Wipro, Wipro Infotech, etc."
                },
                {
                    "ques": "Is Lal Bahadur Shastri Institute of Management, Delhi a good college?",
                    "ans": "Lal Bahadur Shastri Institute of Management, Delhi is among the best colleges in Delhi to get an in-depth understanding of management education."
                },
                {
                    "ques": "What is the course duration at Lal Bahadur Shastri Institute of Management, Delhi?",
                    "ans": "The student must complete two years of full-time course at Lal Bahadur Shastri Institute of Management."
                },
                {
                    "ques": "Lal Bahadur Shastri Institute of Management is affiliated with which university?",
                    "ans": "This institute is affiliated with Guru Gobind Singh Indraprastha University (GGSIPU)"
                },
