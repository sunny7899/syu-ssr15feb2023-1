export const symbiosisinstituteofcomputerstudiesandresearchsicsrpune = {
    ...
    "info": [
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research | Best BCA College" },
                { name: "description", content: "Get the details of BCA admissions at symbiosis institute of computer studies & research ranked #1 among top BCA colleges in India" },
            ],
        },
        {
            type: "meta-title",
            title: "Symbiosis Institute of Computer Studies & Research | Best BCA College"
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune" }
            ]
        }
    ],
    "coursesandfees": [
        ...
        {
            "type": "table",
            "title": "Courses Offered at SICSR",
            "info": "",
            "col": [
                "Courses",
                "Duration",
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - courses & Fees" },
                { name: "description", content: "symbiosis institute of computer studies & research offers a range of courses across a variety of disciplines, including business, arts, humanities, and more. Check available courses and fees" },
            ],
        },
        {
            type: "meta-title",
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune/courses-and-fees" }
            ]
        }
    ],
    "admission": [
        ...
        },
        {
            ...
            info: '',
            data: [
                "Step 1: The admissions at SICSR are purely on merit basis.",
                "Step 2: Candidate needs to apply for Symbiosis Entrance Test and have to undergo for Personal Interaction and Written Ability Test (PI-WAT).",
                "Step 3: For online registration for entrance test, follow the link https://www.set-test.org/.",
                "Step 4: Candidate needs to pay the online registration fees of Rs.1000. It is obligatory for the candidate without which he/she should not be allowed for further PI-WAT process.",
                "Step 5: No capitation fee is charged from any respective institutes of Symbiosis."
            ]
        },
        {
            "type": "list-bollet",
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - Admission 2023 " },
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune/admission" }
            ]
        }
    ],
    "Gallery": [
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - Gallery" },
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune/gallery" }
            ]
        }
    ],
    "Scholarship": [
        {
            ...
            title: 'Scholarships',
            info: '',
            data: '<p><b>1 Undergraduate merit scholarships</b></p><p>semester I program. If the student shall be awarded any other stipend or financial assistance from any other resource then he/she shall communicate the same to the institute. There are no income limits for merit scholarships.</p>'
        },
        {
            type: 'text',
            title: '',
            info: '',
            data: '<p><b>2 University Sports Scholarship</b></p><p>Athletes are awarded to University Sports Scholarships combining sports and education. The main aim of the scholarship is to support the talent of today for the success of sports tomorrow. Rs.24,000 given to sportsman participated in national, international and state level tournaments.</p>'
        },

        {
            ...
            title: '',
            info: '',
            data: '<p><b>3 NER scholarships: (For North Eastern Region)</b></p><p>The scholarship awarded to North Eastern region from respective Government authority of the institute.</p>'
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - Scholarship" },
    ...
    "Faculty": [
        {
            ...
            "row": [
                ...
                {
                    "Name": "Dhananjay Subhashchandra Deshpande",
                    "Position": "Assistant Professor"
                },
                {
                    "Name": "Farhana Imran Desai",
                    "Position": "Assistant Professor"
                },
            ]
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - Faculty" },
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune/faculty" }
            ]
        }
    ],
    "Reviews": [
    ...
    "News": [
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - News & Articles" },
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune/news-and-articles" }
            ]
        }
    ],
    "faq": [
        {
            ...
            "data": [
                {
                    "ques": "What are the specializations available beneath the MSc programme of SICSR Pune?",
                    "ans": "The SICSR Pune MSc programme is offered with specializations which consist of Computer Application (CA) and Security Systems (SS)."
                },
                {
                    "ques": "How many programmes are available at the UG stage at SICSR Pune?",
                    "ans": "Symbiosis Institute of Computer Studies and Research, Symbiosis International, Pune gives undergraduate programmes which consist of BBA (IT) and BCA programmes at UG level."
                },
                {
                    "ques": "How can a candidate pay the application price at SICSR Pune?",
                    "ans": "The application price can be paid online via credit card/ internet banking/ Axis Bank pay-in-slip or a Demand Draft (DD) in favor of Symbiosis Institute of Computer Studies & Research payable at Pune."
                },
                {
                    "ques": "Is SICSR Pune recognized?",
                    "ans": "Symbiosis Institute of Computer Studies and Research, Symbiosis International, Pune is recognized through the UGC. Also, SICSR is re-authorized through NAAC with 'A' Grade. Also, SICSR is placed withinside the heart of Pune City."
                },
            ]
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Symbiosis Institute of Computer Studies & Research - FAQ" },
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/symbiosis-institute-of-computer-studies-and-research-sicsr-pune/faq" }
            ]
        }
    ]
}
