export const athenaschoolofmanagementmumbai = {
    ...
    "info": [
        ...
        },
        {
            ...
            "data": [
                "1 Week Elective in Paris",
                "3 Days a month (Friday, Saturday, Sunday)",
                "1 Week Specialisation in Paris or Shanghai",
                "CXO Level Global Faculty",
                "AMBA Accreditation",
        ...
        {
            type: 'list-bollet',
            title: 'Why Study MBA at Athena School of Management?',
            info: 'The Global Executive program at Athena School of Management has been recognized internationally. The program offers the following leverages to MBA students:',
            data: [
            ...
            "row": [
                {
                    ...
                    "Fees in INR": "INR 6,25,000"
                },
                {
                    "Particulars": "<b>Application Fees (approx)</b>",
                    "Fees in INR": "INR 1,700"
                },
                {
                    "Particulars": "<b>Total Fees</b>",
                    "Fees in INR": "<b>INR 6,26,700</b>"
                }
            ]
        },
        {
    ...
    "review": [
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Athena School of Management - Reviews" },
                { name: "description", content: "Athena School of Management located in mumbai in 2012  is acknowleged as centre of excellance for management institutes. Click here to see reviews" },
            ],
        },
        {
            type: "meta-title",
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/athena-school-of-management-mumbai/reviews" }
            ]
        }
    ],
    "placement": [
    ...
    "gallery": [
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Athena School of Management - Gallery" },
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/athena-school-of-management-mumbai/gallery" }
            ]
        }
    ],
    "scholarship": [
    ...
    "news": [
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Athena School of Management - News & Articles" },
                { name: "description", content: "Get complete details on Athena School of Management,Featured News; Recent News,Trending Articles; Recent Articles. Click Here to know about accomodation" },
            ],
        },
        {
            type: "meta-title",
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/college/athena-school-of-management-mumbai/news-and-articles" }
            ]
        }
    ],
    "hostel": [
        ...
        },
        {
            ...
            "data": [
                ...
                },
                {
                    ...
                    "ans": "Athena School of Management offers the full-time MBA program for a period of 1-2 years."
                },
                {
                    "ques": "Q. What is the cost of an MBA program at Athena School of Management?",
                    "ans": "The MBA in Athena School of Management costs around INR 6 lakhs."
                },
                {
                    "ques": "Q. Are there any hidden charges for placements at Athena School of Management?",
                    "ans": "No, there are no such charges. The placement process at Athena School of Management is completely free of cost."
                }
            ]
        },
        {
