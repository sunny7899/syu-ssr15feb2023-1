export const kremenchukstatetechnicaluniversity= {
    ...
    "url":"kremenchuk-state-technical-university",
        ...
        {
            type: 'list-bollet',
            title: 'Why pursue Engineering at Kremenchuk State Technical University?',
            info: 'Some of the elements which make Kremenchuk State Technical University one of the best options for Indian students to pursue Engineering:',
            data: [
                "Kremenchuk State Technical University is the first university for higher education built in the Poltava region.",
                "One of the largest universities which intend to provide expert education to domestic and international students.",
                "Students from all over the world pursue higher education in different streams at Kremenchuk State Technical University.",
                "The Tuition fee at Kremenchuk State Technical University for every program is affordable.",
                "There are committees that help the Indian students at every step.",
                "The university campus is enormous, and it comprises well-developed infrastructure.",
                "There are Scientific and methodological centers on the campus where students conduct research.",
                "The Admission Procedure is quite simple, and the admission committee aids students with the application form and entrance exam details.",
                "The university has well-equipped laboratories, a library which consists of course books and thousands of additional and research books.",
        ...
        },
        {
            ...
            info: 'Students from all across the world enroll for various programs at Kremenchuk State Technical University:',
            data: [
                "Around 2000-3000 students take admission to the university every year.",
                "The university follows specific guidelines to give admission to international students.",
                "The course offered in Ukrainian and English language.",
        ...
        
        {
            type: 'list-bollet',
            title: 'Accreditation',
            info: 'The worlds leading organizations acknowledge Kremenchuk State Technical University:',
            data: [
                'The university is accredited by the State educational institution "Training Center for Quality Education".',
                "For Quality Assurance, the National Agency in higher education accredited Kremenchuk State Technical University.",
                "The university for approval from the Cabinet Ministry of Ukraine."
            ]
        },
        {
            "type": "table",
            ...
            "row": [
                {
                    ...
                    "Approx Expense (In USD)": "142 USD - 230.72 USD",
                    "Approx Expense (In Indian Rupees)": "Rs 9,940 - Rs 16,150"
                },
                {
                    "Particulars": "Food",
                    "Approx Expense (In USD)": "166.2 USD",
                    "Approx Expense (In Indian Rupees)": "Rs 4,755 - Rs6,657"
                },
                {
                    "Particulars": "Transport",
                    "Approx Expense (In USD)": "5.70 USD",
                    "Approx Expense (In Indian Rupees)": "Rs 400 (Monthly Pass)"
                },
                {
                    "Particulars": "Clothing",
                    "Approx Expense (In USD)": "61.42USD - 86.13 USD",
                    "Approx Expense (In Indian Rupees)": "Rs 4299 - Rs 6029"
                },
                {
                    "Particulars": "Other Expenses",
                    "Approx Expense (In USD)": "40.76USD - 67.93USD",
    ...
    "coursesandfees": [
        ...
        
        {
            ...
            "info": "Kremenchuk State Technical University offers various courses, and the fees of the terms are different:",
            "col": [
                "Courses",
                "Annual Fees (In USD)",
        ...
        {
            "type": "list-bollet",
            "title": "Kremenchuk State Technical University - Course Duration",
            "info": "There are two modes of study, part-time and full time. The course duration of both the modes are as follow:",
            "data": [
                "The course duration of the Engineering program of any stream is 3 years and 10 months. It is a full-time course.",
                "Course Duration for Part-Time Course of the Engineering program of any stream is 4 years and 10 months."
            ]
        },
        {
            "type": "table",
            ...
            "row": [
                ...
                {
                    "Subject of Study": "Automation and instrumentation",
        ...
        },
        {
            "type": "table",
            "title": "",
            "info": "2. Faculty of Economics and Management",
            "col": [
                "Subject of Study",
                "Speciality"
            ],
            "row": [
                {
                    "Subject of Study": "Social and behavioral Management and administration",
                    "Speciality": "Finance, banking, and insurance"
                },
                {
                    "Subject of Study": "Management and administration",
        ...
        },
        {
            "type": "table",
            "title": "",
            "info": "3 Electronics and Computer Engineering",
            "col": [
                "Subject of Study",
                "Speciality"
            ],
            "row": [
                {
                    ...
                    "Speciality": "Secondary education (Computer science)"
                },
                {
                    "Subject of Study": "Information technologies",
                    "Speciality": "Computer science and information technologies"
                },
                {
                    "Subject of Study": "Information technologies",
      ...
      title: "Kremenchuk State Technical University, Ukraine - courses & Fees"},
  {
    ...
    "admission":[
       ...
       
        {
            ...
            "info": "List of the things mentioned below required for admission to Kremenchuk State Technical University:",
            "data": [
                "Students will have to give the Professional Test and English Proficiency Test to seal admission in the desired program.",
                "The students must have all the documents mentioned above and submitted at the stipulated time.",
    ...
    title: "Kremenchuk State Technical University, Ukraine - Placement"},
{
    ...
    "hostel": [

        {
            ...
            "info": "The university campus consists of hostels for international students and is available at nominal charges:",
            "data": [
                "The cost of living at Kremenchuk State Technical University hostel is approx 18 USD (Per Month).",
                "Three hostels on the university campus with five floors in each one.",
                "Separate washrooms and kitchen facilities on each floor of every hostel.",
                "There are eight kitchens in the first hostel and four kitchens in the second and third hostel.",
                "There is one laundry room in every hostel.",
                "24*7 Security at each hostel.",
    ...
    "faq": [
        ...
        {
            "type": "question-list",
            "title": "Kremenchuk State Technical University - Important FAQs",
            ...
            "data": [
                ...
                },
                {
                    ...
                    "ans": "Yes, Kremenchuk State Technical University provides distance learning courses."
                },
                {
                    "ques": "Q. Is there any entrance exam to take admission to Kremenchuk State Technical University?",
