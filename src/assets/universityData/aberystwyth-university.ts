export const aberystwythuniversity = {
    "Title": "Aberystwyth University, UK",
    "shortTitle": "Aberystwyth University",
    "location": "UK",
    "type": "Public",
    "rating": "",
    "shareLink": "",
    ...
    "info": [
        ...
        },
        {
            "type": "text",
            "title": "",
            "data": "<p><b>Aberystwyth University</b> is the preferred choice for doing a BSc and MSc in the UK. Located in Aberystwyth, Wales and established in 1872 and became a founding member of the University of Wales in 1894, and changed its name to the University College of Wales.</p><p>The institute has nearly 8,000 students studying across 3 academic faculties and 17 departments.</p><p>Aberystwyth University is spread over three Campuses; Penglais, Llanbadarn and Gogerddan.</p><p>Aberystwyth University has three campuses - Penglais and Llanbadarn campuses are located a stone’s throw away from the town, Gogerddan campus is the research home for many institutes.</p><p><b>Aberystwyth University is the perfect place for students who are looking for quality education and excellent student life. Enroll today!</b></p>"
        },
        ...
        },
        {
            ...
            data: [
                ...
                "The college provides accommodation and includes a free sports centre platinum membership worth £125 a year.",
                "The university ensures the highest quality of education with innovative research during masters and bachelors in Uk.",
                "Aberystwyth University is one of the top universities in the UK with 90% overall student satisfaction (NSS 2020).",
                "97% of students are graduates in employment or pursuing further study 6 months after graduating from this place.",
                "Aberystwyth University offers an academic excellence scholarship, worth £2,000 in the first year.",
                "The university is providing fantastic education along with a quality of life.",
                "The students union has more than 100 clubs and societies.",
                "The institute has various cafés, restaurants and coffee shops for the staff and students.",
                "The students can work part-time during education to earn some extra money.",
                "The college also provides appointments with specialist staff at the student wellness centre."
            ]
        },
        {
            type: 'list-bollet',
    ...
    "coursesandfees": [
        ...
        {
            "type": "table",
            "title": "Course Duration and Exam (Undergraduate Programs)",
            "info": "A wide spectrum of undergraduate courses are available at Aberystwyth University, go through the duration and exam details:            ",
            "col": [
                "Program",
                "Course duration",
                "Exam"
        ...
        },
        {
            ...
            "row": [
                ...
                ["Geography & Earth Sciences", "History & Welsh History", "Information Studies"],
                ["International English Centre", "International Politics", "Law & Criminology"],
                ["Learn Welsh", "Lifelong Learning", "Mathematics"],
                ["Modern Languages", "Physics", "Psychology"],
                ["School of Veterinary Science	", "Theatre, Film & Television Studies", "Welsh & Celtic Studies"]
            ]
        },
        {
            type: "meta",
    ...
    "admission": [
        ...
        },
        {
            ...
            data: [
                ...
                "The students should pass the English proficiency exam for admission",
                "A-level",
        ...
        },
        {
            ...
            data: [
                ...
                "The applicants must have a high secondary education to take admission.",
        ...
        },
        {
            ...
            data: [
                ...
                "1 satisfactory reference for taught Masters programmes and 2 satisfactory references for research programmes",
                "University transcripts copy",
                "Degree certificates copy",
                "A personal statement within 1-2 A4 pages",
                "Update resume (for Courses that require professional work experience)",
    ...
    "faculty": [
        ...
        },
        {
            ...
            "row": [
                {
                    "Name": "Dr Stephen Atherton",
                    "Designation": "Senior Lecturer",


                },
                {
                    "Name": "Dr Rosemary Cann",
                    "Designation": "Senior Lecturer",


                },
                {
                    "Name": "Mr Prysor Davies",
                    "Designation": "Senior Lecturer",


                },
                {
                    "Name": "Miss Panna Karlinger",
    ...
    "hostel": [
        ...
        },
        {
            ...
            info: 'Enjoy spacious accommodation facilities and stay comfortable at Aberystwyth University:',
            data: [
                "Aberystwyth University offers guaranteed accommodation at university-owned or managed residences for students.",
                "The residence halls and apartments are situated a few minutes away from the college.",
                "There are 7 residence halls on campus with many types and styles of rooms like studios, studio flats, standard bedrooms with shared kitchens and apartments.",
                "The yearly accommodation fee ranges from 3,721 GBP to 6,360 GBP.",
                "The accommodation fee is included in the tuition fees during education.",
                "Provisions like network connection, energy, personal contents insurance and sports centre membership included in the accommodation fees.",
                "All freshmen staying at Pantycelyn hall will get a 100% accommodation fee waiver.",
                "The students who choose not to live on campus can live in private sector accommodation.",
                "Housing facilities are also available for students with disabilities.",
                "All residence places will provide a safe and security where students can study and relax."
            ]
        },
        {
            type: 'list-bollet',
