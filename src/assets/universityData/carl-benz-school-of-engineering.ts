export const carlbenzschoolofengineering= {
    "Title": "Carl Benz School of Engineering, Germany",
    "shortTitle": "CBS",
    "location": "Karlsruhe, Germany.",
    "type": "",
    "rating": "",
    "shareLink": "",
    "url":"carl-benz-school-of-engineering",
    "info": [
        {
            type: 'title',
            title: 'Carl Benz School of Engineering, Germany'
        ...
        {
          "type": "text",
          "title": "About Carl Benz School of Engineering, Germany",
          "data":"Carl Benz School of Engineering (CBS) is a highly-ranked institute to enroll in for the Engineering program. This university was founded in 1999 in Karlsruhe, Germany.<br>This university has three buildings and a spacious campus. It offers exclusive educational facilities to the students that include modern classrooms, laboratories, and practice centers both equipped with modern technology.<br>The university prepares students for their further engineering careers by imparting high-quality education in the English language. At this university, every individual is assigned a personal mentor from the first semester onward.<br>To rejuvenate the enrolled students, the university has arranged recreational spaces to help students relax or indulge in various activities. This university has a panel of young doctoral researchers of the selected institutes to conduct mentoring programs.<br>Are you dreaming of getting enrolled in one of the engineering programs at the Carl Benz School of Engineering? If yes, check out the details below to know more."
        },
          {
            "type": "table",
            "title": "Carl Benz school of Engineering - Quick Highlights",
            "info": "Do you wish to shape your career by getting admission to this prominent university? If yes, go ahead and read below to know more:",
            "col": [
                "Particular",
                "Statistics"
            ],
            "row": [
                {	
                 ...
                 {
                    "Particular": "Parent Institution",
                    "Statistics": "Karlsruhe Institute of Technology"
                },
                {
                    ...
                    "Statistics": "Rs. 15 Lacs"
                }, 
                 {
                    "Particular": "Accepted Exam",
                    "Statistics": "IELTS, TOEFL, SAT"
                },
                 {
                ...
                },
                {
                    "Particular": "University Ranking",
                     "Statistics": "World - 36,Country - 1"
                 },		
                 {
                     "Particular": "Application Portal",
                     "Statistics": "Online"
                 },
                 {
                    "Particular": "Academic Calendar",
                    "Statistics": "NMC, WHOSemester-based"
                },
            ]
        },
        {
            "type":"list-bollet",
            "title":"Why Choose Carl Benz School of Engineering?",
            "info":"The university offers high-quality engineering programs by striving towards excellence. If you want to know why opt for this university, read below:",
            "data":[
                "Carl Benz School of Engineering has a qualified team of professors that delivers elite teaching in small batches. With this, every student gets an opportunity to come forward and put forward their queries in a hassle-free manner.",
                "CBS provides research-based study programs that aim to shape the students for a responsible position in the work area and society.",
                "The university continuously strives hard towards excellence and to prepare a bright future for aspiring engineers by providing specializations in the 5th and 6th semesters.",
                "The institute also has designed language courses that include Technical English, intercultural communication as well as German as a foreign language. Candidates can choose any level between A1, A2, B1, or B2.",
                "The university assigns a personal mentor to each candidate right from the start of the first semester. This facility helps students to stay informed and guided.",
                "This university keeps a record of students' success stories and lets other students know about them, motivating them by celebrating these moments of achievements.",
                "By designing the engineering program in the English language this university ensures that every student understands the complete course without facing language barrier issues.",
                "This university has an affordable fee structure as compared to the other universities. With this fairly moderate fee structure, the university imparts education without compromising its quality.",
                "Carl Benz School of Engineering has recreational spaces that help the candidates to relax, study and make the most of their free time.",
                "By offering specializations in the 5th and 6th semester this university shapes the career of budding engineers and promises a successful career."
            ]
        },
        {
            "type":"text",
            "title":"Medium of Teaching",
            "info":"The University imparts complete Engineering course in the English language:",
            "data":"Complete Engineering course is carried out in the English language. This helps the students to prepare themselves to tackle at the international level.<br>Continuing the complete course in the English language helps students to understand the course better."
        },
        {
            "type":"list-bollet",
            "title":"Facilities Provided at CBS",
            "info":"This university has made several provisions for the students and staff members to ensure they are well facilitated:",
            "data":[
                "Library",
                "Classroom",                 
                "Internet",                 
        ...
        },
        {
            ...
            "info":"The University has received accreditations from the Swiss Council:",
            "data":[
             "Since May 2014, the KIT system has been accredited by AAQ after B.Sc Mechanical Engineering passed the internal quality assurance system.",
             "AAQ agency comes under the Swiss Accreditation council and conducts the accreditation process in the educational institutions in Germany, Switzerland, and Austria."
            ]
        },
       {
        "type":"table",
        "title":"Living Expenses in Karlsruhe, Germany",
        "info":"Wanting to enroll in the Carl Benz School of Engineering? Have a glance at the table below to know the approximate basic expenses for a month:",
        "col":[
            "Particular",	
            "Approx Range in USD",	
            "Approx Range in RS"
            ...
            "row":[
                { 
                "Particular":"Food",	
                "Approx Range in USD":"289 USD",	
                "Approx Range in RS":"Rs 20,230"
                },
                { 
       ...
       { 
        type:"meta",
        meta: [
            { name: "title", content: "Carl Benz School of Engineering, Germany" },
            { name: "description", content: "Do you want to study Engineering in Germany? Get admission to the no. 1 ranked university in Germany, Carl Benz School of Engineering, established in 1999." },
        ],
    },
    {
        type:"meta-title",
