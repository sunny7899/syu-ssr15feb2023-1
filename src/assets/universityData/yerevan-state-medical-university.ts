...
export const yerevanstatemedicaluniversity = {
    "Title": "Yerevan State Medical University, Armenia",
    ...
    "info": [
        ...
        },
        {
            ...
            // img: 'https://www.selectyouruniversity.c41551156515515++om/images/armenia-universities/yerevan-state-medical-university-college.jpg',
            data: '<p>In 1920, <b>Yerevan State Medical University</b> was established.Yerevan State Medical University is one of the top and the best medical institutes in Armenia.</p><p>As it is the oldest university in Armenia, almost hundred years old, it has trained thousands of doctors. Yerevan State Medical University has highly qualified and experienced teachers.</p><p>Thus, students can fulfill their dream of studying MBBS at the Yerevan State Medical University.</p>'
        },
...

        {
            type: "meta",
            meta: [
                { name: "title", content: "Yerevan State Medical University, Armenia" },
                { name: "description", content: "Yerevan State Medical University was established.Yerevan State Medical University is one of the top and the best medical institutes in Armenia." },
            ],
        },
        {
            type: "meta-title",
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/university/yerevan-state-medical-university" }
            ]
        }
    ...
    "admission": [
        ...
        },
        {
            ...
            "data": [
                ...
                "Application Form",
                "Medical record of the health state of the applicant.",
                ...
                "Copy of passport with date of birth or birth certificate (including all pages that have a mark or stamp)",
                "High School Diploma and its copy",
                "Six (6) passport-sized photos",
                "(4×6) Autobiography"
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Yerevan State Medical University, Armenia - Admission 2023" },
                { name: "description", content: "Admission Procedure (2023) Yerevan State Medical University is one of the top and the best medical institutes in Armenia." },
            ],
        },
        {
            type: "meta-title",
        ...
        },
        {
            type: "meta-links",
            link: [
                { rel: "canonical", href: "https://www.selectyouruniversity.com/university/yerevan-state-medical-university/admission" }
            ]
        }
    ],
        "review": [
