export const ivanovostatemedicalacademy = {
    "Title": "Ivanovo State Medical Academy, Russia",
    "shortTitle": "Ivano State Medical Academy",
    "location": "Russia",
    "type": "Private",
    "rating": "",
    "shareLink": "",
    "url": "ivanovo-state-medical-academy",
    "info": [
        {
            type: 'title',
            title: 'Ivanovo State Medical Academy, Russia'
        ...
        {
            "type": "text",
            "title": "About Ivanovo State Medical Academy, Russia",
            "img": "",
            "data": "<p>On 16th June 1930, <strong>Ivanovo State Medical Academy</strong> was established. In the central part of Russia, the Academy is situated. </p><p>Ivanovo State Medical Academy is located in Ivanovo city. The city is 4-5 hours away from Moscow by bus or train.</p><p>The Academy has trained more than 25000 doctors till date. The teaching staff of the Academy includes more than 400 instructors, among them there are more than 270 Candidates of Science and 70 Doctors of Science.</p><p>More than 150 international students from 28 countries study at this university. There are three libraries, a sports center, and three student's hostels in the Academy.</p>"
        },
        {
            "type": "table-title",
            ...
            "row": [
                ...
                ["<b>Processing Time for MBBS Admission</b>", "15 to 20 days"],
                ["<b>Basic Eligibility</b>", "50% in PCB (45% for SC/ST)"],
                ["<b>NEET Exam</b>", "Yes, it is compulsory"],
                ["<b>University Ranking</b>", "Country Rank - 160<br> World Rank - 4237"],
                ["<b>Course Duration</b>", "5 years + 1 year of internship"],
                ["<b>University Recognition</b>", "Approved by NMC, WHO, FAIMER, USMLE"],
                ["<b>Medium of Education</b>", "English (Russian language taught for internship)"]
            ]
        },

        {
            ...
            "data": [
                ...
                "Indian food is available for the students.",
                "The MBBS degree from this university is approved by NMC, WHO, etc. and hence students can work anywhere after completing MBBS from Ivanovo State Medical Academy.",
                "Campus of this university is very big and there are hostels in the campus so students can easily reach the university.",
                "The campus of the university is safe for students.",
        ...
        },
        {
            ...
            "data": [
                ...
                "The library is huge and has a large collection of books.",
                "The Electronic Library of the University was also created in the IvSMA, in order to improve the information support of the educational and research work of the academy, and to increase the efficiency of user service."
            ]
        },
        {
            "type": "list-bollet",
            ...
            "data": [
                ...
                "For all categories of usersExpansion and provision of additional services.",
                "Improvement and Development of the library's image."
            ]
        },
        {
            "type": "text",
            ...
            "row": [
                {
                    ...
                    "Cost": "Ranges in between Rs.30 - Rs.540"
                ...
                },
                {
                    ...
                    "Cost": "Cost between Rs.10,800 - Rs.16,000"

                }
            ],
            heading: '<p><strong style="color: red;"><u>Note</u>:</strong>$1 = Rs.70Rs.</p>'
        },
        {
            "type": "list-bollet",
            ...
            "data": [
                ...
                "At Ivanovo city, the climate is temperate continental. Summer at Ivanovo is warm, but not hot; winter is moderately frosty with permanent snow cover. The coldest month in Ivanovo is January with an average monthly temperature of minus 12 degrees Celsius, the warmest month of summer is July, where average monthly temperature goes till plus 18.8 degrees Celsius.",
    ...
    "coursesandfees": [
        {
            ...
            "row": [
                ...
                {
                    "Particular": "<b>Health Insurance</b>",
                    "First Year": "$64",
                    "Second Year": "$64",
                    "Third Year": "$64",
                    "Fourth Year": "$64",
                ...
                },
                {
                    ...
                    "First Year": "Rs.1.55 Lakhs",
                    "Second Year": "Rs.1.48 Lakhs",
                    "Third Year": "Rs.1.29 Lakhs",
                    "Fourth Year": "Rs.1.23 Lakhs",
                    "Fifth Year": "Rs.1.17 Lakhs",
                    "Sixth Year": "Rs.1.08 Lakhs"

                }
            ],
            heading: '<p><strong style="color: red;"><u>Note</u>:</strong> 1$ = Rs.70 ( It may vary )</p><p>Food charges, etc. can be extra up to Rs.70,000/- (or more approximately).</p><p>As the fees are approximate, they may vary as per the change in currency.</p>'
        },
        {
            "type": "table",
    ...
    "admission": [
        ...
        },
        {
            ...
            data: [
                ...
                "Step 4: The Registration Fees should be paid to the University Account.",
    ...
    "hostel": [
        {
            ...
            "data": [
                ...
                "The facilities provided at the university are as per international standard, as students from all over the world come, live and study at the Ivanovo State Medical Academy.",
                "The dormitory is under high security.",
                "All the rooms of the hostel are well ventilated, spacious and furnished with beds, pillows, blanket, mattress, etc.",
                "In every hostel, reading rooms and gym are accommodated.",
                "The hostels are provided with round the clock security and assistance for safety of every student staying in the hostel.",
                "Students can also rent off campus housing/flats in private apartments. The price varies depending on the size and location of the flat.",
