export const privolzhskyresearchmedicaluniversity = {
    "Title": "Privolzhsky Research Medical University, Russia",
    "shortTitle": "Privolzhsky Research Medical University",
    "location": "Russia",
    "type": "Private",
    "rating": "",
    "shareLink": "",
    "url": "privolzhsky-research-medical-university",
    "info": [
        {
            type: 'title',
            title: 'Privolzhsky Research Medical University, Russia'
        ...
        },
        {
            ...
            "data": [
                ...
                "The educational system of Privolzhsky Research Medical University is based on the latest principles and current trends of development and medical development.",
                "The medium of teaching at Privolzhsky Research Medical University for the MBBS course is in the English language.",
                "Privolzhsky Research Medical University provides a high standard of education with the use of modern management and internal education quality control.",
                "Privolzhsky Research Medical University acknowledged by the World health organization (WHO) and recognised by the National Medical Commission (NMC).",
                "Privolzhsky Research Medical University carries out basic and clinical research for the students learning MBBS, and this shows the overall potential of the University.",
                "The university has cooperation with medical scientific research institutes and centres of the Russian Academy of Sciences and the Russian Academy of Medical Sciences, other Russian and foreign universities.",
                "The students can participate in the development of programmes which are aiming at health promotion of Volga Federal Region citizens and other regions.",
                "Privolzhsky Research Medical University offers a reasonable fee structure which makes it very much affordable for worldwide medical aspirants to pursue MBBS.",
                "The graduates are awarded a first professional medical degree of M. D. (Doctor of Medicine).",
                "Privolzhsky Research Medical University has been recognized by the Ministry of Higher Education to train medical professionals across the world.",
                "Privolzhsky Research Medical University has 600 highly professional and experienced teaching staff members."
            ]
        },
        {
            "type": "text",
    ...
    "admission": [
        {
            ...
            "data": [
                ...
                "Students who have cleared the NEET examination with an eligible score can apply for the MBBS course in Privolzhsky Research Medical University.",
        ...
        },
        {
            ...
            "data": [
                ...
                "Certificate of Equivalence- A document of recognition of educational certificates in Russia issued by Mian State Center for Education Evaluation.",
                "The candidate should submit a certificate of English Knowledge (if possible) and get admission in an MBBS course.",
    ...
    "hostel": [
        {
            ...
            "data": [
                ...
                "All rooms have high-speed internet access round the clock for study and fun purposes."
            ]
        },
        {
            "type": "list-bollet",
        ...
        },
        {
            ...
            "info": "",
            "data": [
                "Indian restaurants and Indian food are available for Indian students.",
                "The hostel is equipped with a common kitchen where students can cook their own food of choice.",
                "The hostel provides a mess facility where the students will get 3 meals in a dining hall."
            ]
        },
        {
            "type": "list-bollet",
