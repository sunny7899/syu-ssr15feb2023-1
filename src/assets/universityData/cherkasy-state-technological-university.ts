export const cherkasystatetechnologicaluniversity = {
    "Title": "Cherkasy State Technological University, Ukraine",
    "shortTitle": "Cherkasy State Technological University",
    "location": "Ukraine",
    "type": "Public",
    "rating": "",
    "shareLink": "",
    "url": "cherkasy-state-technological-university",
    "info": [
        {
            type: 'title',
            title: 'Cherkasy State Technological University, Ukraine'
        },
        {
            "type": "text",
            "title": "",
            "data": "<p><strong>Cherkasy State Technological University</strong> is one of the top-leading public universities started in 1960 at Cherkasy, Ukraine. During the 50-year existence, more than 40 thousand specialists are trained in different courses at Cherkasy State Technological University.</p><p>Cherkasy State Technological University offers national economic experts from the field of engineering, technological, cybernetic, construction, environmental, financial, economic and linguistic skills.</p><p>Cherkasy State Technological University provides education to the students with the guidance of 500 teachers with scientific degrees and academic titles account for about 40%, including 53 doctors and professors.</p><p>The Institute has 8 faculties, 46 departments, among them 31 graduate departments. Currently, Cherkasy State Technological University has overall 8000 students for 38 specialities and 26 directions of training.</p><p>Cherkasy State Technological University has the main goal of the implementation of advanced training technologies and offering a high standard of education to the students coming from different parts of the world.</p>"
        },

        {
            "type": "table-title",
            "title": "Cherkasy State Technological University: Quick Overview",
            "info": "Check out the main highlights before enrolling into the Cherkasy State Technological University:",
            "row": [
                ["<b>Tuition Fees</b>", "210.00 – 288.00 USD"],
                ["<b>Course Duration</b>", "4 years"],
                ["<b>Teaching Medium</b>", "English language"],
                ["<b>University Ranking</b>", "World - 6327<br>Country - 80"],
                ["<b>Accreditation</b>", "Ministry of Education and Science of Ukraine"]
            ]
        },
        {
            type: 'list-bollet',
            title: 'Why Choose Cherkasy State Technological University?',
            info: 'Let’s dive into the advantages of studying in Cherkasy State Technological University:',
            data: [
                "Cherkasy State Technological University provides a quality education system with an organised curriculum for Engineering education.",
                "The fee structure of Cherkasy State Technological University is designed with a focus on the affordability of students.",
                "Cherkasy State Technological University conducts several seminars and guest lectures in the spacious auditorium.",
                "Students graduating from Cherkasy State Technological University are awarded the universally accepted degree.",
                "The institute has a well-developed and furnished infrastructure with a huge campus area.",
                "Cherkasy State Technological University provides English teaching to worldwide students.",
                "Cherkasy State Technological has various International relationships with the USA, Canada, Germany, France, Spain, Netherlands, Poland, Bulgaria, Russia, Moldova, Greece, Slovakia, Armenia, China, Georgia, Belarus, Czech Republic and others.",
                "The faculty members pay great attention to the research work of students in Cherkasy State Technological University."
            ]
        },
        {
            type: 'list-bollet',
            title: 'Facilities Provided at Cherkasy State Technological University',
            info: 'The infrastructure of Cherkasy State Technological University fulfills all basic requirements by providing modern facilities:',
            data: [
                "Cherkasy State Technological University has modern computer classes with an internet connection.",
                "The library has more than 370,000 copies of scientific, educational, normative and technical, artistic, foreign literature, including 186,000 educational literature, 790 abstracts and dissertations, 170 titles of periodicals, more than 4,000 electronic resources.",
                "Cherkasy State Technological University offers high-speed internet connectivity.",
                "Cherkasy State Technological University has top-class residential facilities for a comfortable stay.",
                "Cherkasy State Technological University provides quality and delicious food on the university campus.",
                "Cherkasy State Technological University provides spacious and air-conditioned classrooms equipped with modern facilities in the comfort zone of the students.",
                "Cherkasy State Technological University also conducts guest lectures, seminars, presentations in a huge auditorium."
            ]
        },
        {
            "type": "table-title",
...

        {
            ...
            info: 'Cherkasy State Technological University provides English teaching for Engineering course:',
            data: "<p>Cherkasy State Technological University offers English teaching to the students coming to study from different parts of the world. The students won’t be facing any language barrier during education.</p>"
        },
        {
            "type": "table",
            "title": "Cherkasy State Technological University: Ranking 2022",
            "info": "According to Unirank, check out the country & world rankings of Cherkasy State Technological University:",
            "col": [
                "Country",
                "World",
            ],
...

        {
            ...
            info: 'Cherkasy State Technological University is officially accredited and recognized the known organisations:',
            data: "<p>The institute has the Accreditation Ministry of Education and Science of Ukraine.</p>"
        },
        {
            "type": "table",
            "title": "Living Cost of Cherkasy, Ukraine",
            "info": "Cherkasy provides affordable living expenses to the students which may vary according to individual requirements:",
            "col": [
                "Particulars",
                "Amount in USD",
                "Amount in Rs"
...

        {
            ...
            data: [
                ...
                "It is the capital of Cherkasy Oblast.",
                "Cherkasy is the administrative centre of surrounding Cherkasky Raion within the oblast.",
                "The Cherkasy is designated as a city of oblast significance and does not belong to the rain.",
                "Cherkasy city has a total area of about 78 km²",
                "The weather of Cherkasy is 1 °C, Wind E at 14 km/h, 91% Humidity",
                "Cherkasy city has a population of 2.79 lakhs"
            ]
        },
        {
            type: 'list-bollet',
            title: '',
            info: 'Here are some top sights of the city one must visit -',
            data: [
                "Friendship of Peoples' Palace of Culture",
                "Arboretum Sofiyivka",
        ...
        },
        {
            type: "meta",
            meta: [
                { name: "title", content: "Cherkasy State Technological University" },
                { name: "description", content: "Cherkasy State Technological University, the top-leading public university started in 1960. It offers great options to study in Ukraine." },
            ],
        },
        {
            type: "meta-title",
